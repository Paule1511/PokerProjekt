...
function getFlushMax(){
    [score, comb] = getFlushScore(['HA', 'HK', 'HQ', 'HJ', 'H10']);
    return score;
}
...
function getStraightMax(){
    [score, comb] = getStraightScore(['HA', 'HK', 'HQ', 'HJ', 'H10']);
    return score;
}
...
function getRoyalStraightFlushMax(){
    [score, comb] = getStraightFlushScore(['HA', 'HK', 'HQ', 'HJ', 'H10']);
    return score;
}

function getStraightFlushMax(){
    [score, comb] = getStraightFlushScore(['HK', 'HQ', 'HJ', 'H10', 'H9']);
    return score;
}
...
const cardArray = new Array('C10', 'C9', 'S5', 'S4', 'S3', 'S6', 'S7');

// console.log(getStraightScore(cardArray));
